...
import com.baktygaliyev.blog.domain.dtos.ApiErrorResponse;
...
public class ErrorController {
    ...
    public ResponseEntity<ApiErrorResponse> handleBadCredentialsException(EntityNotFoundException exception) {
        ApiErrorResponse error = ApiErrorResponse.builder()
